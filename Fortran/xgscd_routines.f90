...
!!!!SJT: imported kind_parameters module to each routine (in elliptic.f90) giving access to kind parameters controlling variable precision
...
m=real(1.0_qp-mc_qp,8); mc=real(mc_qp,8) !!SJT: quad precision used to reduce the impact of cancellation errors
kc=sqrt(mc)
ux=abs(u)
